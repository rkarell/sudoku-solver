# Sudoku solver
An application that solves sudokus, implemented with Javascript. Not brute-force style but one number at a time using sophisticated algorithms.
